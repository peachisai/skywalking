...
package org.apache.skywalking.oap.server.ai.evalution.storage;
...
@Stream(name = AIEvalutionResultRecord.INDEX_NAME, scopeId = DefaultScopeDefine.AI_EVALUATION_RESULT,
    builder = AIEvalutionResultRecord.Builder.class, processor = RecordStreamProcessor.class)
public class AIEvalutionResultRecord extends Record {

    public static final String INDEX_NAME = "ai_evalution_result";
    ...
    public static class Builder implements StorageBuilder<AIEvalutionResultRecord> {
        @Override
        public AIEvalutionResultRecord storage2Entity(final Convert2Entity converter) {
        ...
        @Override
        public void entity2Storage(final AIEvalutionResultRecord storageData, final Convert2Storage converter) {
