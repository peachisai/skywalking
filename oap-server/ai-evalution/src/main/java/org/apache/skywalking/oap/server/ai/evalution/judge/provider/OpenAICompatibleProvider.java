...
package org.apache.skywalking.oap.server.ai.evalution.judge.provider;
...
import org.apache.skywalking.oap.server.ai.evalution.AIEvalutionConfig;
import org.apache.skywalking.oap.server.ai.evalution.judge.JudgeModelProvider;
import org.apache.skywalking.oap.server.ai.evalution.judge.JudgeModelRequest;
...
public class OpenAICompatibleProvider implements JudgeModelProvider {
    ...
    public OpenAICompatibleProvider(final AIEvalutionConfig.Judge config) {
        this(HttpClient.newHttpClient(), config);
    }

    OpenAICompatibleProvider(final HttpClient httpClient, final AIEvalutionConfig.Judge config) {
